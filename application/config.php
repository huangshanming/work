...
return [
    //融云
    'APP_KEY' => 'pwe86ga5pi0b6',
    'APP_SECRET' => 'RFBEPf5kCyjyn',
    // +----------------------------------------------------------------------
    // | 应用设置
    // +----------------------------------------------------------------------

    'extra_config_list'      => ['code'],
    'photo_path'             => 'http://zupu.com/upload/',
    'photo_upload'           => '../public/upload/',
    'img_len'                => 150,
    // 应用调试模式
    'app_debug'              => true,
    // 应用Trace
    ...
    'RONG_DEV_APP_KEY'       => 'pwe86ga5pi0b6', //融云开发环境下的key       仅供测试使用
    'RONG_DEV_APP_SECRET'    => 'RFBEPf5kCyjyn', //融云开发环境下的SECRET     仅供测试使用
