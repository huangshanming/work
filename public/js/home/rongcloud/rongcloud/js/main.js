...
function rongCreateFriendInfo(userInfo) {
    userInfo['avatar'] = userInfo['avatar']?userInfo['avatar']:'../img/clear.png';
    // 判断是否是学霸
    ...
    var str='<div class="bjy-fl-one" data-edu="" data-avatar="'+userInfo['avatar']+'" data-username="'+userInfo['username']+'" data-uid="'+userInfo['id']+'"><div class="bjy-flo-avatar" data-username="'+userInfo['username']+'"><img class="bjy-floa-img" src="'+userInfo['avatar']+'">'+approveImg+countStr+'</div><ul class="bjy-flo-info"><li class="bjy-flo-username">'+userInfo['username']+'<span class="bjy-flou-time">'+userInfo['date']+'</span></li><li class="bjy-flo-school"></li></ul></div>';
    return str;
}
